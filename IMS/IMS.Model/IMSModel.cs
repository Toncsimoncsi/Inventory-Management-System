...
namespace IMS.Model
{
        ...
        //}
            ...
            //    if (_gameTable[x, y] != Entity.NoEntity) // ellenőrizzük a mezőt
            ...
            public async Task LoadGameAsync(String path)
            {
                ...
                //if (values.Count(value => value == Entity.EntityO) != values.Count(value => value == Entity.EntityX) && values.Count(value => value == Entity.EntityO) + 1 != values.Count(value => value == Entity.EntityX))
                ...
                //_stepNumber = values.Count(value => value != Entity.NoEntity); // leszámoljuk, hány lépés történt
                //_currentEntity = _stepNumber % 2 == 0 ? Entity.EntityX : Entity.EntityO; // a lépésszámból kijön az aktuális játékos
